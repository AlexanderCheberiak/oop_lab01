...
/// <summary>
/// This class provides an empty implementation of <see cref="ILab01Visitor{Result}"/>,
...
public partial class Lab01BaseVisitor<Result> : AbstractParseTreeVisitor<Result>, ILab01Visitor<Result> {
	/// <summary>
	...
	public virtual Result VisitMultiplicativeExpr([NotNull] Lab01Parser.MultiplicativeExprContext context) { return VisitChildren(context); }
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	public virtual Result VisitExponentialExpr([NotNull] Lab01Parser.ExponentialExprContext context) { return VisitChildren(context); }
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	public virtual Result VisitAdditiveExpr([NotNull] Lab01Parser.AdditiveExprContext context) { return VisitChildren(context); }
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	public virtual Result VisitComparisonExpr([NotNull] Lab01Parser.ComparisonExprContext context) { return VisitChildren(context); }
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	public virtual Result VisitNumberExpr([NotNull] Lab01Parser.NumberExprContext context) { return VisitChildren(context); }
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	public virtual Result VisitParenthesizedExpr([NotNull] Lab01Parser.ParenthesizedExprContext context) { return VisitChildren(context); }
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	public virtual Result VisitNotExpr([NotNull] Lab01Parser.NotExprContext context) { return VisitChildren(context); }
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	public virtual Result VisitCompileUnit([NotNull] Lab01Parser.CompileUnitContext context) { return VisitChildren(context); }
